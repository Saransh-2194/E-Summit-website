...
export const InfiniteMovingSpeakers = ({
  items,
  direction = "left",
  speed = "slow",
  pauseOnHover = true,
        ...
        {items.map((item, idx) => (
          ...
          >
            <div className="relative w-full h-full">
              <img src={item.image} alt={item.name} className={`object-cover w-full h-full rounded-xl ${imageClassName}`} />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent text-white p-2 text-center rounded-b-xl text-xl">
                {item.name}
              </div>
            </div>
          </li>
